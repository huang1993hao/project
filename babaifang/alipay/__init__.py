...
# 支付宝封装(不需要做任何修改)
from Django01.settings import ALIPAY_ROOT
...
# 初始化操作
appid = '2016091900547742'
app_notify_url = 'http://39.105.177.201/notifyurl/' # 支付完成后，支付宝调用的(通知AXF服务端)
return_url = 'http://39.105.177.201/returnurl/' # 支付完成后，AXF客户端跳转的页面
...
alipay_axf = AliPay(
    ...
    return_url=return_url,  # 同步支付通知url,在这个页面可以展示给用户看，只有付款成功后才会跳转
)